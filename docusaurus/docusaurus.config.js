...
const config = {
  ...
  projectName: "Agent-API", // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: "https://github.com/Praktikant-Klobuerste/Agent-API",
            label: "GitHub",
            position: "right",
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Agent - API. Built with Docusaurus.`,
      },
      prism: {
